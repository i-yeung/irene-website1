...
const CONTINENT_MARKERS = [
{
  ...
  latLng: [50, -100],
  name: 'North America',
  countries: ['PR', 'DO', 'DM', 'LC', 'NI', 'PA', 'CA', 'SV', 'HT', 'TT', 'JM', 'GT', 'HN', 'BZ', 'BS', 'CR', 'US', 'MX', 'CU'],
  default: true,
  percentage: 10 },
...

{
  ...
  latLng: [45, 130],
  name: 'Asia Pacific',
  countries: ['GU', 'PW', 'RU', 'KI', 'NC', 'NU', 'NZ', 'AU', 'PG', 'SB', 'BD', 'MN', 'BN', 'BH', 'BT', 'HK', 'JO', 'PS', 'LB', 'PF', 'FJ', 'FM', 'WS', 'VU', 'LA', 'TW', 'TR', 'LK', 'TL', 'TM', 'TJ', 'TH', 'XC', 'NP', 'PK', 'PH', '-99', 'AE', 'CN', 'AF', 'IQ', 'JP', 'IR', 'AM', 'SY', 'VN', 'GE', 'IL', 'IN', 'AZ', 'ID', 'OM', 'KG', 'UZ', 'MM', 'SG', 'KH', 'CY', 'QA', 'KR', 'KP', 'KW', 'KZ', 'SA', 'MY', 'YE'],
  default: false,
  percentage: 11.5 }];
